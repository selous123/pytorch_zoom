...
apath = os.path.join(ARGS.root_path, 'ssl_addfushion_reverse_x4_addmixattn')
...
plt.subplot(121)
plt.plot(axis, loss_log.numpy(),color = 'red' ,label= "mixv0.1")
...
plt.subplot(122)
plt.plot(axis, psnr_log.numpy().squeeze(),color = 'red' ,label= "mixv0.1")
